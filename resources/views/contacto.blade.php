        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                ...
                <p class="mt-6 text-xl text-indigo-100 max-w-3xl mx-auto">
                    Estamos aquí para ayudarte. Completa el formulario y nos pondremos en contacto contigo lo antes
                    posible.
                </p>
            </div>
        </div>
    ...
    <div class="bg-gray-50 py-16">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-md p-8">
                ...
                <form id="contactForm" method="POST" action="{{ route('contacto.store') }}" x-data="{
                    submitting: false,
                    showSuccess: false,
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="servicio_interes" id="servicio_interes"
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            <button type="submit" :disabled="submitting"
                                ...
                                <span x-show="submitting" x-cloak style="display: none;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow duration-300">
                    <div class="flex justify-center mb-4">
                        <div
                            class="w-16 h-16 bg-gradient-to-r from-indigo-500 to-blue-500 rounded-full flex items-center justify-center">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <p class="text-center">
                        <a href="mailto:info@fisioclinic.com"
                            class="text-indigo-600 hover:text-indigo-700 font-semibold text-lg">
            ...
            <div x-data="{ openFaq: 1 }" class="space-y-4">
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    <button @click="openFaq = openFaq === 1 ? null : 1"
                        ...
                        <i class="fas fa-chevron-down text-indigo-600 transition-transform duration-200"
                            :class="{ 'rotate-180': openFaq === 1 }"></i>
                    </button>
                    <div x-show="openFaq === 1" x-transition class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <p class="text-gray-600">
                            Puedes reservar una cita de tres formas: llamando al +34 965 123 456, enviándonos un email a
                            info@fisioclinic.com, o directamente a través de nuestra plataforma web en la sección de
                            tratamientos. Solo necesitas estar registrado para realizar reservas online.
                        </p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div x-show="openFaq === 2" x-transition class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <p class="text-gray-600">
                            Nuestro centro está abierto de lunes a viernes de 9:00 a 21:00 horas. Esta amplitud horaria
                            nos permite adaptarnos a tus necesidades y ofrecerte la mejor atención en el horario que más
                            te convenga.
                        </p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div x-show="openFaq === 3" x-transition class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <p class="text-gray-600">
                            No es necesario presentar receta médica para la mayoría de nuestros tratamientos de
                            fisioterapia. Sin embargo, si dispones de prescripción médica o informe médico, te
                            recomendamos traerlo a tu primera consulta para que nuestros profesionales puedan conocer
                            mejor tu situación.
                        </p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div x-show="openFaq === 4" x-transition class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <p class="text-gray-600">
                            Aceptamos efectivo, tarjetas de crédito/débito (Visa, Mastercard), y transferencias
                            bancarias. El pago se realiza al finalizar cada sesión, aunque también ofrecemos bonos de
                            sesiones con descuento para tratamientos continuos.
                        </p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div x-show="openFaq === 5" x-transition class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <p class="text-gray-600">
                            Sí, puedes cancelar o modificar tu cita con al menos 24 horas de antelación sin ningún
                            coste. Para ello, contacta con nosotros por teléfono o email. Te pedimos que nos avises con
                            tiempo para poder ofrecer ese hueco a otros pacientes.
                        </p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div x-show="openFaq === 6" x-transition class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <p class="text-gray-600">
                            Sí, disponemos de parking en el mismo edificio del centro. Además, estamos muy bien
                            comunicados por transporte público: la estación de cercanías de Alicante está a pocos
                            minutos a pie.
                        </p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div x-show="openFaq === 7" x-transition class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <p class="text-gray-600">
                            La duración de cada sesión varía según el tratamiento específico, pero generalmente oscila
                            entre 30 y 60 minutos. En la primera consulta, el fisioterapeuta evaluará tu caso y te
                            informará sobre la duración estimada de las sesiones.
                        </p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div x-show="openFaq === 8" x-transition class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <p class="text-gray-600">
                            Trabajamos con las principales compañías aseguradoras. Te proporcionamos toda la
                            documentación necesaria para que puedas solicitar el reembolso a tu aseguradora. Consulta
                            con nosotros para verificar si estamos en tu cuadro médico.
                        </p>
                    </div>
                </div>
            </div>
