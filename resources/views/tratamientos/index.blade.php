                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="duracion_min" id="duracion_min"
                            value="{{ request('duracion_min') }}" min="0" step="5" placeholder="0"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="duracion_max" id="duracion_max"
                            value="{{ request('duracion_max') }}" min="0" step="5" placeholder="120"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                </div>
                        ...
                        <div class="px-6 py-4">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center text-gray-700">
                                    ...
                                    <span
                                        class="text-lg font-bold text-indigo-600">{{ number_format($tratamiento->precio, 2) }}€</span>
                                </div>
                            </div>
                        </div>
