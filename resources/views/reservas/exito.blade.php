        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    @if ($reserva->es_para_otro)
                        ...
                        <span
                            class="inline-block mt-2 px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded">Reserva
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">{{ \Carbon\Carbon::parse($reserva->hora_inicio)->format('H:i') }}
                    </p>
                </div>
