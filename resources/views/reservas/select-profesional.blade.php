...
<head>
    ...
    <title>Seleccionar Profesional - {{ $tratamiento->nombre }} - FisioClinic</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2">
                    ...
                    <li>
                        <a href="{{ route('tratamientos.show', $tratamiento) }}" class="text-gray-500 hover:text-gray-700">{{ $tratamiento->nombre }}</a>
                    </li>
                    <li>
                        <svg class="h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                    ...
                    <li>
                        <span class="text-gray-900 font-medium">Seleccionar Profesional</span>
                    </li>
                </ol>
            </nav>
        </div>
