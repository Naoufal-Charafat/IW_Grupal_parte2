            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <p class="mt-2 text-sm text-blue-700">
                        Elige el profesional de tu preferencia. Podrás ver su disponibilidad y seleccionar la fecha y
                ...
                <div
                    ...
                    <div class="bg-gradient-to-r from-indigo-500 to-blue-500 px-6 py-8 text-white text-center">
                        <div class="inline-flex items-center justify-center w-24 h-24 bg-white rounded-full mb-4">
                            <svg class="h-16 w-16 text-indigo-600" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="px-6 py-6">
                        @if ($profesional->numero_licencia)
                            <div class="flex items-center text-gray-600 mb-3">
                                <svg class="h-5 w-5 mr-2 text-indigo-600" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
